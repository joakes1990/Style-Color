...
class GalleryButtonView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let imageView: UIImageView = UIImageView(frame: CGRect(x: (bounds.width / 2) - 20,
                                                           ...
                                                           width: 40,
                                                           height: 30))
        imageView.image = #imageLiteral(resourceName: "gallery")
        
        addSubview(imageView)
        
        layer.backgroundColor = #colorLiteral(red: 0.8470588235, green: 0.8470588235, blue: 0.8470588235, alpha: 1)
    }
